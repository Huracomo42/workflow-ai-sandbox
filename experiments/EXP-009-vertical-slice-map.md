...
| VS-03 | Filtrar por estado sin modificar ni persistir datos | RF-06, RF-08, RF-09, RF-10, RF-11, RF-14 | `index.html`, `app.js`, `styles.css`, `test-runner.js` | opciones; aplicación inmediata; no escritura; recarga; cambio a completada | medio | diferida |
