...
| Resultado técnico | Calidad de las pruebas | 4 | `T007-01` a `T007-09`: 9/9 PASS; regresión de `T005-01` a `T005-10`: 10/10 PASS sin cambios. Se realizó además una verificación manual en Microsoft Edge, que comprobó edición, persistencia tras recarga, conservación del estado completado y cancelación sin persistencia; las capturas de esa verificación no quedaron archivadas dentro del repositorio. El puntaje permanece en 4/5 porque la evidencia disponible demuestra cobertura suficiente y correcta, pero no justifica elevarla a 5/5 como cobertura excepcional o exhaustiva. |
